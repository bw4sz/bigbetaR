...
#' Cell by branch matrix calculation
#' @description This function computes the presence of species in each cell by evaluating which nodes are present. Often used for phylogenetic community structure analysis
#' @seealso picante::mpd
